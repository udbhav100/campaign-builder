...
import { Card, Button, Input, Badge } from './Common.jsx';
import { OBJECTIVES, OBJECTIVES_CONFIG } from '../types.js';
import { generateSuggestionsFromUrl } from '../utils.js';
import { generateRealCampaignSuggestions } from '../services/gemini.js';
...
// --- Step 2: URL & Location ---
export const StepUrl = ({ url, setUrl, name, setName, city, setCity, campaign, updateCampaign }) => {
...
export const StepAutoSetup = ({ campaign, updateCampaign }) => {
...
// --- Step 4: Slider ---
export const StepGoalSlider = ({ value, onChange, estimates, objective }) => {
...
export const StepCompetitor = ({ strategy, onChange, campaign, updateCampaign }) => {
...
// --- Step 6: Review ---
export const StepReview = ({ campaign, onEditStep, confirmed, setConfirmed, updateCampaign }) => {
        ...
        <ReviewSection title="Objective & Destination" step={1}>
            <div className="flex items-start gap-4">
                <div className="p-2 bg-blue-100 text-blue-600 rounded-lg">
                    {objective?.icon && React.createElement(objective.icon, {size: 20})}
                </div>
